        ...
        protected virtual void CreateCharacter(string[] inputParams)
        {
            switch (inputParams[1])
            {
                case "mage":
                    ...
                    {
                        case "Red":
                            this.characterList.Add(new Mage(inputParams[2], int.Parse(inputParams[3]), int.Parse(inputParams[4]), 1, 1, Team.Red, 1));
                            break;
                        case "Blue":
                            this.characterList.Add(new Mage(inputParams[2], int.Parse(inputParams[3]), int.Parse(inputParams[4]), 1, 1, Team.Blue, 1));
                            break;
                    }
                    break;
                ...
                case "warrior":
                    ...
                    {
                        case "Red":
                            this.characterList.Add(new Warrior(inputParams[2], int.Parse(inputParams[3]), int.Parse(inputParams[4]), 1, 1, Team.Red, 1));
                            break;
                        case "Blue":
                            this.characterList.Add(new Warrior(inputParams[2], int.Parse(inputParams[3]), int.Parse(inputParams[4]), 1, 1, Team.Blue, 1));
                            break;
                    }
                    break;
                ...
                case "healer":
                    ...
                    {
                        case "Red":
                            this.characterList.Add(new Healer(inputParams[2], int.Parse(inputParams[3]), int.Parse(inputParams[4]), 1, 1, Team.Red, 1));
                            break;
                        case "Blue":
                            this.characterList.Add(new Healer(inputParams[2], int.Parse(inputParams[3]), int.Parse(inputParams[4]), 1, 1, Team.Blue, 1));
                            break;
                    }
                    break;
                default:
